...
function Button({
    ...
    onClick,
    disabled,
    variant = "header-button" }: ButtonProps) {
    ...
    const baseStyle = "flex flex-row w-full h-[48px] items-center justify-center gap-[5px] rounded-xl transition-transform duration-100 active:scale-95 disabled:opacity-50 disabled:active:scale-100";
